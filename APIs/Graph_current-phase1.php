...
$mid=$_GET['mid'];
$sql = "SELECT reading_time,Current_A FROM sensordata WHERE Device_Id = '{$mid}' ORDER BY reading_time DESC LIMIT 3";
$myArray = array();
if($result = mysqli_query($con,$sql))
{
    while($row = mysqli_fetch_array($result))
  {
    ...
    $myArrayItem= array("reading_time" =>  $row['reading_time'] ,"Current_A" =>  $row['Current_A']);
